...
IF ~NumTimesTalkedTo(0)~ THEN BEGIN 0
  SAY @4780
  IF ~!Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,0) RandomNumLT(100,26)~ THEN REPLY @4782 GOTO 1
  IF ~!Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,25)~ THEN REPLY @4781 GOTO 2
  IF ~Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,0) RandomNumLT(100,6)~ THEN REPLY @4782 GOTO 1
  IF ~Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,5)~ THEN REPLY @4781 GOTO 2
END
...
IF ~~ THEN BEGIN 2
  ...
  IF ~!Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,75)~ THEN GOTO 18
  IF ~Kit(LastSeenBy(Myself),MAGESCHOOL_NECROMANCER) RandomNumGT(100,75)~ THEN GOTO 25
END
